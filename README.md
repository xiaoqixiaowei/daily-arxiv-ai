...
# How to use
This repo will daily crawl arXiv papers about **cs.CV, cs.GR, cs.CL and cs.AI**, and use an OpenAI-compatible LLM such as **GLM-5.1** (`glm-5.1`) to summarize the papers in **Chinese**.
